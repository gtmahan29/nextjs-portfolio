...
const Hero = () => {
  return (
    <div className="py-10 md:py-20 h-screen relative">
      ...
      {/* <div className="">
        <Image
          src="/assets/Crystals&Gems(9).png"
          width={200}
          height={200}
          alt=""
          className="absolute bottom-[10rem] -left-[4rem] z-[99] opacity-70"
        />
        <Image
          src="/assets/Crystals&Gems(22).png"
          width={200}
          height={200}
          alt=""
          className="absolute top-[15rem] -right-[10rem] z-[99] opacity-70"
        />
      </div> */}
