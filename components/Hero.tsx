    ...
    <div className="pb-20 h-screen">
      ...
      <div className="h-screen flex flex-col items-center justify-center relative z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col justify-center items-center">
          ...
          <p className="text-center md:tracking-wider mt-8 text-sm md:text-lg lg:text-2xl">
            I'm Mahan. A Professional Web Developer
          </p>
        </div>
        <a href="#about" className="mt-8">
          {/* <button className="px-10 py-3 text-[18px] rounded-lg bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200">
            More Info
          </button> */}
          <a
